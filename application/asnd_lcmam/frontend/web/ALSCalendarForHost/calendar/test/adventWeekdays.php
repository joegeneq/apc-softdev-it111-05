...
try {
    ...
    while ($row = $sth->fetch(PDO::FETCH_ASSOC)) {
        ...
        $e['color'] = '#3399FF';
        $e['textColor'] = 'White';
        $e['description'] = "This is the Marker for this Weekday of Advent.";
        ...
        $e['textColor'] = 'White';
            ...
            if ($row['weekday_first_optional'] == ""){
                $e['description'] = "This is the First Reading for this Weekday of Advent." . "<br>" . "No optional readings.";}
            else{
                $e['description'] = "This is the First Reading for this Weekday of Advent." . "<br>" . "Optional: " . $row['weekday_first_optional'];
            }
        ...
        $e['start'] = $allWeekdays[$counter] . "T01:00:06";
            ...
            if ($row['weekday_alleluia_optional'] == ""){
                $e['description'] = "This is the Alleluia Verse for this Weekday of Advent." . "<br>" . "No optional readings.";}
            else{
                $e['description'] = "This is the Alleluia Verse for this Weekday of Advent." . "<br>" . "Optional: " . $row['weekday_alleluia_optional'];
            }
        ...
        $e['start'] = $allWeekdays[$counter] . "T01:00:07";
            ...
            if ($row['weekday_responsorial_optional'] == ""){
                $e['description'] = "This is the Responsorial Psalm for this Weekday of Advent." . "<br>" . "No optional readings.";}
            else{
                $e['description'] = "This is the Responsorial Psalm for this Weekday of Advent." . "<br>" . "Optional: " . $row['weekday_responsorial_optional'];
            }
        ...
        $e['start'] = $allWeekdays[$counter] . "T01:00:08";
            ...
            if ($row['weekday_gospel_optional'] == ""){
                $e['description'] = "This is the Gospel for this Weekday of Advent." . "<br>" . "No optional readings.";}
            else{
                $e['description'] = "This is the Gospel for this Weekday of Advent." . "<br>" . "Optional: " . $row['weekday_gospel_optional'];
            }
