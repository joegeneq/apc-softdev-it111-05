...
class Event extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'event_first_audio' => 'Event First Audio',
            'event_second_reading' => 'Event Second Reading',
            'event_second_audio' => 'Event Second Audio',
            'event_alleluia_verse' => 'Event Alleluia Verse',
            'event_alleluia_audio' => 'Event Alleluia Audio',
            'event_responsorial_psalm' => 'Event Responsorial Psalm',
            'event_responsorial_audio' => 'Event Responsorial Audio',
            'event_gospel' => 'Event Gospel',
            'event_gospel_audio' => 'Event Gospel Audio',
            'event_first_optional' => 'Event First Optional',
            'event_second_optional' => 'Event Second Optional',
            'event_responsorial_optional' => 'Event Responsorial Optional',
            'event_alleluia_optional' => 'Event Alleluia Optional',
